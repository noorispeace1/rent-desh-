...
const SignUpPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Card Container */}
      <Card className="w-full max-w-md bg-white/95 backdrop-blur-md rounded-[2rem] p-6 md:p-8 border border-white/20 shadow-2xl mt-4 mb-4">
        ...
        <div className="flex flex-col items-center justify-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#3E2723] tracking-tight">Create an Account</h1>
          <p className="text-[#795548] text-sm mt-1 text-center">
            Join RentDesh to unlock premium verified properties.
          </p>
        </div>
