    ...
    return (
        <div ref={bannerRef} className="relative w-full min-h-[85vh] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-7xl px-4 md:px-8 flex flex-col items-center text-center mt-10">
                ...
                >
                    {/* Location Input */}
                    <div className="flex w-full md:w-1/4 items-center bg-white rounded-2xl px-4 py-3.5 transition-all focus-within:ring-2 focus-within:ring-gray-800">
                    ...
                    {/* Min Price */}
                    <div className="flex w-full md:w-[15%] items-center bg-white rounded-2xl px-4 py-3.5 transition-all focus-within:ring-2 focus-within:ring-gray-800">
                        <DollarSign className="text-gray-400 w-5 h-5 mr-1" />
                        <input 
                            type="number" 
